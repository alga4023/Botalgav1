...
petik = '```'
fake = '© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 𝔇𝔢𝔫𝔞𝔯𝔞 𝔅𝔬𝔱𝔰'//GANTI NAMA KAMU BEP
ban =[]
...
module.exports = dha = async (dha, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = dha.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "Pilih Disini","footerText": "© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 𝔇𝔢𝔫𝔞𝔯𝔞 𝔅𝔬𝔱𝔰","listType": "SINGLE_SELECT","sections": list}}, {})
     ...
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
       ...
       console.error(err)
        ...
        const ftoko = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./media/sherlynn.jpg`)},"title": `© 𝔇𝔢𝔫𝔞𝔯𝔞 𝔅𝔬𝔱𝔰`,"description": "ℭ𝔯𝔢𝔞𝔱𝔬𝔯 𝔇𝔢𝔫𝔞𝔯𝔞 𝔅𝔬𝔱𝔰", "currencyCode": "IDR","priceAmount1000": "999999","retailerId": "𝔇𝔢𝔫𝔞𝔯𝔞 𝔅𝔬𝔱𝔰","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
...
*Sewa bot?* Chat wa.me/6285727492435`
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: '© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 𝔇𝔢𝔫𝔞𝔯𝔞 𝔅𝔬𝔱𝔰7', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
*Cek list Server GTLI dibawah!*`
               ...
               footerText: '© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 𝔇𝔢𝔫𝔞𝔯𝔞 𝔅𝔬𝔱𝔰', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
*Cek list Server GTIVD dibawah!*`
       ...
       case 'othercmd':
               ...
               startnum = 0
               for (let x of listmenu) {
               const yy = {title: '© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 𝔇𝔢𝔫𝔞𝔯𝔞 𝔅𝔬𝔱𝔰 ' + nombor++,
                    rows: [
                       {
                        title: `${listmenuu[startnum++]}`,
                        description: ``,
       ...
       case 'store':
               ...
               listmsg(from, `${ucapanWaktu}`,   `© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 𝔇𝔢𝔫𝔞𝔯𝔞 𝔅𝔬𝔱𝔰`, list)
               break
//------------------< Game >------------------- 
        case 'limitgame': 
        case 'balance': 
...
//------------------< Premium >-------------------
       ...
       case 'sewabot':
              ...
              teksnya = `*[ PRICE LIST ]*
*Sewa Bot 𝔇𝔢𝔫𝔞𝔯𝔞 𝔅𝔬𝔱𝔰 ON 24 Jam*
*1 Hari :* 5K
*1 Minggu :* 10K
*1 Bulan :* 15K
* Manen :* 20K
...
*Minat Join? Chat* wa.me/6285727492435
#WAVEFOREVER!`
              dha.sendMessage(from, await getBuffer(gopeynya), image, {quoted: ftoko, caption: teksnya })
              break
...
case 'tiktok':
              ...
              imageMsg = (await dha.prepareMessageMedia(fs.readFileSync(`./media/sherlynn.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/sherlynn.jpg`)})).imageMessage
              buttonsMessage = {footerText:'Jangan Lupa Subscribe Yt 𝔇𝔢𝔫𝔞𝔯𝔞 𝔅𝔬𝔱𝔰\n Helpme tu 1k subscriber', imageMessage: imageMsg,
...
dha.sendMessage(_.jid, 
			{"contentText": `*「 Siaran 𝔇𝔢𝔫𝔞𝔯𝔞 𝔅𝔬𝔱𝔰 」*\n© 𝔇𝔢𝔫𝔞𝔯𝔞 𝔅𝔬𝔱𝔰\n*Isi Pesan :* ${body.slice(4)}`,
			"footerText": '© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 𝔇𝔢𝔫𝔞𝔯𝔞 𝔅𝔬𝔱𝔰',
			"buttons": [
...
//------------------< Menunya Bang:v >-------------------
      case 'dana':
         ...
         case 'pulsa':
             ...
             break              
      case 'infoig':
             reply(`Follow Instagram Owner Ya : https://www.instagram.com/denarabot`)
             break
      case 'grupbot':
